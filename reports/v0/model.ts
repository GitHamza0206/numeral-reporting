...
export const model = defineReportModel({
  meta: {
    ...
    period: "Janvier-Decembre 2025",
    year: 2025,
    priorYear: 2024,
    generatedAt: "2026-01-01T12:00:00+00:00",
    source: "Donnees factices — remplacer par votre export comptable reel",
  },
  pnl: {
    subtitle: "Compte de resultat factice pour illustrer la mise en page.",
    footnote: "Tous les montants sont des exemples ; les remplacer par les valeurs du dossier reel.",
    score: {
      global: 58,
      level: "douteux",
      levelLabel: "Douteux",
    ...
    charges: [
      { label: "Achats consommes", n: 165847, n1: 125744 },
  ...
  alerts: {
    blocking: [
      {
        label: "Banque A — decaissements en attente de reclassement",
        account: "4716",
        amount: 8094,
      ...
      },
      {
        ...
        account: "4717",
        amount: 31034,
        comment: "Exemple factice : meme logique que pour les decaissements.",
      },
    ],
    blockingTotal: 39128,
    points: [
      ...
      },
      {
        ...
        severity: "erreur",
        amount: 18726,
        comment: "Illustration erreur — coherence bilan / compte de resultat a controler.",
      },
    ],
  },
  sig: {
  ...
  monthly: {
    headers: ["Jan", "Fev", "Mar", "Avr", "Mai", "Jun"],
  ...
  structure: {
    balance: {
      actif: [
        ...
        { label: "Creances et avances", amount: 51928 },
        { label: "Tresorerie", amount: 71901, bold: true },
      ],
      passif: [
        { label: "Capital et reserves", amount: 68364 },
        { label: "Resultat provisoire", amount: -48194, bold: true },
    ...
    ratios: [
      { label: "BFR", value: "-22 674 €", hint: "Exemple simplifie." },
      { label: "Tresorerie nette", value: "71 079 €", hint: "Tresorerie brute moins dettes financieres." },
    ],
  },
  analyse: {
    scoring: {
    ...
    narratives: {
      score: "Texte factice : commenter le score global une fois le dossier reel charge.",
      pnl: "Texte factice : interpreter le compte de resultat apres traitement des donnees.",
      monthly: "Texte factice : decrire la saisonnalite ou les pics de charges.",
      structure: "Texte factice : expliquer les grandes masses du bilan.",
      sig: "Les SIG sont illustratifs ; les comparer aux précédents exercices réels.",
    },
    synthese: [
      {
        label: "Donnees",
    ...
    footerExtra: [
      "Ce rapport est un gabarit : ne pas utiliser tel quel pour une decision financiere ou fiscale.",
    ],
  },
});
