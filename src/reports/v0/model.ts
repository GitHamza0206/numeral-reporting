  ...
  REPORT_471_MODE === "v0"
    ...
    : {
      ...
      details: [
        ...
        {
          label: "Crédits suspens banque vers produits et subventions — proposition",
          account: "À valider sur fichier des écritures",
          n: 30916.77,
          variant: "adjusted" as const,
        },
      ],
...
export const model = defineReportModel({
  meta: {
    title: "Rapport financier — Bande de Cheffe",
