import { defineReportModel, type ReportAlert } from "../../schemas/report.ts";
...
export const model = defineReportModel({
  meta: {
    title: "Rapport financier — Bande de Cheffe · QA modale historique",
  ...
  pnl: {
    subtitle:
      "Compte de résultat par nature — regroupement charges et produits d’après les intitulés PennyLane (mapping cabinet).",
    footnote:
      REPORT_471_MODE === "v0"
